function addWebring(response) {
    var base = $("<div>", {class: "webring-container-food"});
    var inner = $("<div>", {class: "inner-webring-container-food"});
    ...
    var links = $("<div>", {class: "webring-links-food"});
    links.append("[")
    ...
    links.append("]");
    inner.append(links);
    inner.append($("<p>", {class: "copyright-food"}).text("©1991 Webringer"));
