...
characters = [
    ...
    Character(first_name="Benesek", last_name="Tredinnick", gender_run1="Male", gender_run2="Male", age=50, profession="Business owner", relationship_status="Widowed", children=True, contact_with_siblings="I don't have siblings", star_sign="Virgos"),
    ...
    Character(first_name="Oliver", last_name="Moon", gender_run1="Male", gender_run2="Female", age=24, profession="Unemployed", relationship_status="???", children=False, contact_with_siblings="Yes", star_sign="Aquarius"),
    ...
    Character(first_name="Dorian", last_name="Carter", gender_run1="Male", gender_run2="Male", age=39, profession="Public services", relationship_status="Single", children=False, contact_with_siblings="No", star_sign="Virgos"),
    ...
    Character(first_name="Selina", last_name="Blair", gender_run1="Female", gender_run2="Female", age=39, profession="Professional", relationship_status="???", children=False, contact_with_siblings="No", star_sign="Virgos"),
    ...
    Character(first_name="Hykka", last_name="Jelbert", gender_run1="Male", gender_run2="Female", age=46, profession="Unemployed", relationship_status="Separated", children=True, contact_with_siblings="No", star_sign="Aries"),
